...
object PreferenceHelper {
    ...
    fun SharedPreferences.getTheme(
        ...
        var deviceThemeDark = false
        when (currentNightMode) {
            Configuration.UI_MODE_NIGHT_YES -> deviceThemeDark = true
        }
        val applicationThemeDark = getBoolean("application_theme", deviceThemeDark)
        return if (applicationThemeDark) AppCompatDelegate.MODE_NIGHT_YES else AppCompatDelegate.MODE_NIGHT_NO
    }
}