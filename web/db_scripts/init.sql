...
create table comment (id uuid primary key DEFAULT uuid_generate_v4(), content text, user_id uuid, constraint fk_user foreign key(user_id) references app_user(id), post_id uuid, constraint fk_post foreign key(post_id) references post(id));
